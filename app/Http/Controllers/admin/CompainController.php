...
class CompainController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.compains.index' , compact('compains'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.compains.create', compact('offices' , 'projects'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('admin/compain')->withStatus(__('Compain Created Successfully.'));
    }
    ...
    public function edit(compain $compain)
    {
        ...
        $offices = Offices::all();
        $projects = Project::all();
        return view('admin.compains.edit', compact('compain','offices' , 'projects'));
    }

    public function update(Request $request, compain $compain)
    {
        $compain->update($request->all());
        return redirect('admin/compain')->withStatus(__('Compain Updated Successfully.'));
    }
