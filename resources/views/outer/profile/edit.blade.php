...
<div class="ps-main__wrapper">
    ...
    <section class="ps-new-item">
        <form method="post" action="{{ url('outer/profile/update',$user) }}" autocomplete="off" class="form-horizontal" enctype="multipart/form-data">
            @csrf
            @method('put')
                        ...
                        <figure class="ps-block--form-box">
                            ...
                            <div class="ps-block__content">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control datepicker" name="dob" type="text" placeholder="{{ __('Date Of Birth') }}" value="{{ old('dob', $user->dob) }}" autocomplete="off"/>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" placeholder="Emergency Name" name="emgname" value="{{ old('emgname', $user->emgname) }}" autocomplete="off"/>
                                </div>

                                <div class="form-group">
                                    <label>Emergency Number
                                    </label>
                                    <input class="form-control" type="text" placeholder="Emergency Number" name="emgrnum" value="{{ old('emgrnum', $user->emgrnum) }}" autocomplete="off"/>
                                </div>
                                <div class="form-group">
                                    <label>Relation
                                    </label>
                                    <input class="form-control" type="text" placeholder="Relation" name="emgrrelation" value="{{ old('emgrrelation', $user->emgrrelation) }}" autocomplete="off"/>
                                </div>
                            </div>
                        </figure>
                    </div>
