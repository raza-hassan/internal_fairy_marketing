...
<div class="ps-main__wrapper">
    ...
    <section class="ps-new-item">
        ...
        <div class="ps-section__content">
            ...
            <form method="post" action="{{ url('role/update' ,$role) }}">
                @csrf
                    ...
                    <div class="row">
                        <div class="col-xs-8">
                            <div class="form-group">
                                ...
                                <div>
                                    <input class="form-control" type="text" name="name" type="text" required placeholder="{{ __('Role Name') }}" value="{{old('name' , $role->name)}}">
