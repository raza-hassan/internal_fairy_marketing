...
<html lang="en">
    ...
    <body>
        ...
        <nav class="navbar">
            <div class="container">
                ...
                @if(Auth::user()->role == 0)
                    <div class="navbar-menu" id="open-navbar1">
                        <ul class="navbar-nav">
                            ...
                            <li class="{{ $activePage == 'affiliators' ? 'active' : '' }}"><a href="{{url('admin/affiliators')}}">Affiliates</a></li>
                    ...
                    <div class="navbar-menu" id="open-navbar1">
                        <ul class="navbar-nav">
                            ...
                            @if(Auth::user()->can('affiliator.view'))
                                <li class="{{ $activePage == 'affiliators' ? 'active' : '' }}"><a href="{{url('/affiliators')}}">Dealer Networks</a></li>
                            @endif
                ...
                <div  class="bottom-header">
                    ...
                    @if(Auth::user()->role != 10 && Auth::user()->role != 11 )

                        <a href="{{url('lead/create')}}" class="add-leads-icon bottom-icon">
                            <i class="fa fa-plus" aria-hidden="true"></i>
                        </a>

                        {{--=============== Notification Bell Icon Code================ --}}
                        <div  id="fairy_notification">
                            {{-- <a href="#" class="add-leads-bell bottom-icon"><i class="fa fa-bell" aria-hidden="true"></i></a> --}}
                            @php
                                if(Auth::user()->role==1 || Auth::user()->role==5 || Auth::user()->role==13 || Auth::user()->role==14){

                                    $unread_notifications = App\Models\Notification::
                                                    where('role_read_at' , Null)->where('read_by_role' , Null)->
                                                    where('user_read_at' , Null)->where('read_by_user' , Null)->
                            ...
                            @endphp
                            <li class="dropdown notification_li_dropdown" >
                            ...
                            <style>
                                #mark_all_as_read_row{
                                    background: #446161 !important;
                                    border-radius: 10px;
                                    margin-left: 3%;
                                    margin-bottom: 5px;
                                    display:flex;
                        ...
                        <a href="{{url('todolist')}}" class="add-leads-bell bottom-icon">
                    ...
                    <a href="#" class="add-leads-user bottom-icon">
                        <div class="dropdown">
                            ...
                            <img src="{{ url('storage/app/public/'.Auth::user()->profile) }}">
                            @else
                            ...
                            <div class="dropdown-content">
                                @if(Auth::user()->role == 9)
                                    <p><a href="{{url('outer/profile/edit')}}" class="add-leads-bell bottom-icon">Profile</a></p>
                                @else
                                    <p><a href="{{url('profile/edit')}}" class="add-leads-bell bottom-icon">Profile</a></p>
                                @endif
                                {{-- <p><a href="{{url('profile/edit')}}" class="add-leads-bell bottom-icon">Profile</a></p> --}}
                                ...
                                @if(Auth::user()->can('target.view'))
                                    <p><a href="{{url('targets')}}" class="add-leads-bell bottom-icon">Targets</a></p>
                                @endif


                                @if(Auth::user()->can('role-in-permission.view'))
                                    <p><a href="{{url('role-in-permissions')}}" class="add-leads-bell bottom-icon">RIP</a></p>
                                @elseif(Auth::user()->can('role.view'))
                                    <p><a href="{{url('roles')}}" class="add-leads-bell bottom-icon">Roles</a></p>
                                @elseif(Auth::user()->can('permission.view'))
                                    <p><a href="{{url('permissions')}}" class="add-leads-bell bottom-icon">Permissions</a></p>
                                @endif


                                <p><a href="{{url('/logout')}}" class="add-leads-bell bottom-icon">Log Out</a></p>
                            </div>
                        </div>
                    </a>
        ...
        //                 url:'allnotification/'+notification,
        //                 type:"GET",
        //                 dataType:"json",
