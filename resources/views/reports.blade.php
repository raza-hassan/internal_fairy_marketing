    ...
    <section class="ps-items-listing">
        ...
        <div class="ps-section__header">
            ...
            <div class="ps-section__filter">
                ...
                <form class="ps-form--filter" action="{{url('dashboard/search')}}" method="post">
        ...
        <?php
            ...
            $unassigned = count($leads) - $assigned_leads;
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 filter-sec">
            ...
            <ul class="lead_sorting">
                ...
                <li><label>Assigned Leads : {{$assigned_leads}}</label></li>


                <li><label>Unassigned Leads :  {{ $unassigned }}</label></li>
