                ...
                <div class="row">
                        ...
                        <div class="card card-home main_total_unit">
                            <div class="card-body">
                                <div class="height_155">
                                    ...
                                    <h4 class="mt-4 font-weight-bold mb-2 d-flex align-items-center"><label>Achive:</label><span> {{ number_format($user_target['achive_unit_target']) }} </span></h4>
                    ...
                    <div class="row detail_boxes_div" id="detail_boxes"  style="display:none">
                        ...
                        <div class="col-sm-6 col-xl-4">
                            <div class="card card-home main_whole_unit">
                                <div class="card-body">
                                    <div {{-- class="height_143" --}}>
                                        <h6 class="font-size-xs text-uppercase"> Affiliator Contacted Calls </h6>
