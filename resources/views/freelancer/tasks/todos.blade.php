...
<div class="ps-main__wrapper">
   ...
   <section class="ps-items-listing">
       <div class="ps-section__header">
           <div class="row">
               <form class="ps-form--filter" action="{{url('affiliator/user/task')}}" method="get">
                       ...
                       <div class="form-group">
                           ...
                           <div class="bootstrap-select fm-cmp-mg">
                               <select class="form-control" name="user_id">
                                   <?php
                                           $user_id = Auth::guard('affiliator')->user()->user_id;
                                       ?>
	...
	<div class="row ">
           <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
               <ul class="nav nav-tabs tab-nav-center task">
                   <li class="<?php if($todo == 'overdue' || $todo == ''){ echo 'active'; } ?>"><a href="{{url('affiliator/todos/overdue')}}">Overdue (<?php echo $overdue; ?>)</a></li>
                   <li class="<?php if($todo == 'today'){ echo 'active'; } ?>"><a href="{{url('affiliator/todos/today')}}">Today (<?php echo $today; ?>)</a></li>
                   <li class="<?php if($todo == 'tomorrow'){ echo 'active'; } ?>"><a href="{{url('affiliator/todos/tomorrow')}}">Tomorrow (<?php echo $tomorrow; ?>)</a></li>
                   <li class="<?php if($todo == 'week'){ echo 'active'; } ?>"><a href="{{url('affiliator/todos/week')}}">7 Days (<?php echo $week; ?>)</a></li>
                   <li class="<?php if($todo == 'all' ){ echo 'active'; } ?>"><a href="{{url('affiliator/todos/all')}}"> Month (<?php echo $alltasks; ?>)</a></li>
               </ul>
           </div>
       </div>
                           ...
                           <td>
                               ...
                               <div class="client-title tooltip">
                                   <div class="tooltiptext client-info">
                                       ...
                                       <div class="inner-side"><label>Client Number: </label><span>{{ str_replace(' ','',$record->client->phone) }}</span></div>
                                       <div class="inner-side"><label>Client Email: </label><span>{{ $record->client->email }}</span></div>
                                   </div>
                                   <a href="{{url('affiliator/client/edit',$record->client_id)}}" class="client-title">
               ...
               <div class="modal-body">
                   <figure class="ps-block--form-box">
                       ...
                       <div class="ps-block__content">
                           ...
                           <input type="hidden" name="added_by" id="added_by" value="{{Auth::guard('affiliator')->user()->id}}"> --}}
