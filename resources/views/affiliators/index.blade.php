...
<div class="ps-main__wrapper">
    ...
    <header class="header--dashboard">
        ...
        <div class="header__right">
            <a class="ps-btn success" href="{{ route('affiliators.create') }}"><i class="icon icon-plus mr-2"></i>New
                Affiliator</a>
        </div>
        @endif
    </header>
    <section class="ps-items-listing">
                            ...
                            <div class="form-group">
                                ...
                                <div class="bootstrap-select fm-cmp-mg">
                                    <input class="form-control" name="name" id="input-name" type="text"
                                        placeholder="{{ __('Enter Name') }}" value="{{app('request')->input('name')}}">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="bootstrap-select fm-cmp-mg">
                                    <input class="form-control" name="phone" id="input-name" type="text"
                                        placeholder="{{ __('Enter Cell') }}" value="{{app('request')->input('phone')}}">
                                </div>
                            </div>
                        </div>
                        @if(count($users) > 0)
                            ...
                            <div class="form-group">
                                ...
                                <div class="bootstrap-select fm-cmp-mg">
                                    <select class="form-control" name="user_id">
                                        @if (Auth::user()->role == 1 || Auth::user()->role == 5 || Auth::user()->role ==
                                        13 || Auth::user()->role == 14)
                                        ...
                                        <option <?php if($user_id==$user->id ){ echo 'selected'; } ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="bootstrap-select fm-cmp-mg">
                                    <select class="form-control" name="type">
                                        ...
                                        <option <?php if(app('request')->input('type') == 'Dealer'){ echo 'selected'; }
                                            ?> value="Dealer">Dealer</option>
                                        <option <?php if(app('request')->input('type') == 'Freelancer'){ echo
                                            'selected'; } ?> value="Freelancer">Freelancer</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="bootstrap-select fm-cmp-mg">
                                    <select class="form-control" name="status">
                                        <option <?php if(app('request')->input('status') == ''){ echo 'selected'; } ?>
                                            value="">Select Status </option>
                                        <option <?php if(app('request')->input('status') == 1){ echo 'selected'; } ?>
                                            value="1">Active</option>
                                        <option <?php if(app('request')->input('status') == 0 &&
                                            app('request')->input('status') != ''){ echo 'selected'; } ?>
                                            value="0">InActive</option>
                                        <option <?php if(app('request')->input('status') == 2){ echo 'selected'; } ?>
                                            value="2">Rejected</option>
                                        <option <?php if(app('request')->input('status') == 3){ echo 'selected'; } ?>
                                            value="3">Again Approval Request</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                            <div class="form-group">
                                ...
                                <select class="form-control locations_select2" name="location_id[]" multiple>
                                    ...
                                    <option value="{{ $location->id }}" {{ in_array($location->id,
                                        request()->input('location_id', [])) ? 'selected' : '' }}>
                                        {{ $location->full_path }}
                                    </option>
                                    @endforeach
                                </select>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="name-col">
                                ...
                                <a href="{{route('affiliators.edit',$affiliator->id)}}"><strong>{{ $affiliator->name
                                        }}</strong></a>
                                @else
                            ...
                            <td>
                                ...
                                <a href="{{url('affiliator/leads', $affiliator->id)}}">{{ $lead_count }}</a>
                            </td>
                            @else
                            {{ $lead_count }}
                            @endif
                            ...
                            <td>
                                ...
                                <form action="{{ route('affiliators.destroy', $affiliator->id) }}" method="post">
                                    ...
                                    <a rel="tooltip" href="#" data-original-title="" title="" data-toggle="modal"
                                        data-id="<?php echo $affiliator->id; ?>" data-target="#tasklog"
                                        id="get_affiliator_Task">
                                        <i class="fa fa-calendar" aria-hidden="true"></i>
                                    </a>
                                    <a rel="tooltip" href="#" data-original-title="" title="" data-toggle="modal"
                                        data-id="<?php echo $affiliator->id; ?>" data-target="#myModalthree"
                                        id="affiliatortask">
                                        <i class="fa fa-plus" aria-hidden="true"></i>
                                    </a>
                                    @if(Auth::user()->can('affiliator.trash'))
                                    <button type="button" data-original-title="" title="" onclick="confirm('{{ __(" Are
                                        you sure you want to delete this Record?") }}') ? this.parentElement.submit()
                                        : ''">
                                    ...
                                    <a href="#" class="transferAffiliator" data-toggle="modal"
                                        ...
                                        data-from_user_id="{{ $affiliator->user_id }}">
        ...
        <div class="modal fade" id="transferAffiliatorMoal" role="dialog">
            <div class="modal-dialog modal-default">
                <form method="post" action="{{ url('affiliator/transfer/store') }}" class="form-horizontal"
                    id="transfer_lead_from" enctype="multipart/form-data">
                    @csrf
                    @method('post')
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <figure class="ps-block--form-box">
                                <figcaption>Affiliator Transfer </figcaption>
                                <div class="ps-block__content">
                                    ...
                                    <input type="hidden" name="affiliator_id" id="taffiliator_id">
                                    <input type="hidden" name="from_user_id" id="tfrom_user_id">
                                    <input type="hidden" name="transferred_by" value="{{Auth::user()->id}}">
                                    <div class="form-group">
        ...
        <div class="modal fade" id="myModalthree" role="dialog">
            <div class="modal-dialog modal-default">
                <form method="post" action="{{ url('affiliator/task') }}" autocomplete="off" class="form-horizontal"
                    id="taskform" enctype="multipart/form-data">
                    @csrf
                    @method('post')
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <figure class="ps-block--form-box">
                                ...
                                <div class="ps-block__content">
                                    ...
                                    <div class="form-group" id="callsubtype">
                                        ...
                                        <select name="subtype" id="subtype" class="form-control select-picker"
                                        ...
                                        <span id="name-error" class="error text-danger subtype-error"
                                            for="input-name"></span>
                                    </div>
                                    <div class="form-group affmeetinglocation" id="affmeetinglocation"
                                        style="display: none;">
                                        <label>Location<sup>*</sup></label>
                                        <select name="location" id="aff_location" class="form-control select-picker"
                                            data-size="8">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control completion_date" type="text" name="completion_date"
                                            value="{{ old('duedate', date('m/d/Y')) }}" />
                                    </div>
                                    ...
                                    <div class="form-group" id="ntasktype">
                                        <label>Select Type<sup>*</sup></label>
                                        <select name="ntype" id="ntype" class="form-control select" required=""
                                            data-size="8">
                                    ...
                                    {{-- <div class="form-group">
                                        ...
                                        <input class="form-control deadline" type="text" placeholder="Deadline"
                                            name="deadline" value="{{ old('deadline', date('m/d/Y')) }}">
                                    </div> --}}
                                    {{-- ========================== --}}
                                    @php
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <input class="form-control deadline" type="text" placeholder="Deadline"
                                                    name="deadline" required value="{{old('deadline')}}"
                                                    {{--value="{{ old('deadline', date('m/d/Y')) }}" --}}>
                                            </div>
                                            {{-- <div class="col-md-6">
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-success button" id="affliator_submit_task">Save
                                changes</button>
                            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                        </div>
                    </div>
        ...
        <div class="ps-section__footer">
            <p>Showing {{($affiliators->currentpage()-1)*$affiliators->perpage()+1}} to
                {{$affiliators->currentpage()*$affiliators->perpage()}}
...
<script>
    $(document).on('click', '.transferAffiliator', function () {
