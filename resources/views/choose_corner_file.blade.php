...
<div class="ps-main__wrapper">
    <header class="header--dashboard">
        <div>
            <h3>Update Product Corner With CSV File</h3>
            <p>Import File</p>
        </div>
        @if ($errors->any())
    ...
    <section class="ps-new-item">
        <form method="post" action="{{url('corner/product/prices') }}" autocomplete="on" class="form-horizontal" enctype="multipart/form-data">
            @csrf
            @method('get')
