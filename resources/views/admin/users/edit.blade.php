                        ...
                        <figure class="ps-block--form-box">
                            ...
                            <div class="ps-block__content">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="cnic" type="text" placeholder="{{ __('CNIC') }}" value="{{ old('cnic', $user->cnic) }}"/>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" placeholder="Emergency Name" name="emgname" value="{{ old('emgname', $user->emgname) }}"/>
                                </div>

                                <div class="form-group">
                                    <label>Emergency Number
                                    </label>
                                    <input class="form-control" type="text" placeholder="Emergency Number" name="emgrnum" value="{{ old('emgrnum', $user->emgrnum) }}"/>
                                </div>
                                <div class="form-group">
                                    <label>Relation
                                    </label>
                                    <input class="form-control" type="text" placeholder="Relation" name="emgrrelation" value="{{ old('emgrrelation', $user->emgrrelation) }}"/>
                                </div>
                            </div>
                        </figure>
                    </div>
