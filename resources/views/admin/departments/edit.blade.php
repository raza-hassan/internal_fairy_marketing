...
<div class="ps-main__wrapper">
    ...
    <section class="ps-new-item">
        <form method="post" action="{{ url('admin/departments/update' , $departments) }}"  class="form-horizontal" id="leadForm">
            @csrf
            @method('put')
                            ...
                            <div class="ps-block__content">
                                ...
                                <div class="accountdiv" style="display: @if(old('account') == '0') none @else block @endif;">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control name"  name="name" type="text" placeholder="{{ __('Name') }}" value="{{ old('type',$departments->name) }}" required=""/>
                                </div>


                                {{-- <div class="accountdiv" style="display: @if(old('account') == '0') none @else block @endif;">
                                    <div class="form-group">
                                        <label>Lead Type<sup>*</sup></label>
                                        <input class="form-control type"  name="type" type="text" placeholder="{{ __('type') }}" value="{{ old('type',$status->type) }}" required=""/>
                                    </div> --}}
            ...
            <div class="ps-form__bottom">
                <a class="ps-btn ps-btn--black" href="{{url('admin/departments')}}">Cancel</a>
