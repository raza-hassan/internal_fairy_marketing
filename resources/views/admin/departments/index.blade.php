...
<div class="ps-main__wrapper">
    ...
    <header class="header--dashboard">
        ...
        <div class="header__right">
            <a class="ps-btn success" href="{{ url('admin/departments/create') }}"><i class="icon icon-plus mr-2"></i>Add New</a>
        </div>
                ...
                <tbody>
                    ...
                    <tr class="gradeX">
                        ...
                        <td class="td-actions text-right ">
                            ...
                            <form action="{{ url('admin/departments/destroy', $record) }}" method="post">
                                @csrf
                                @method('delete')

                                <a rel="tooltip" class="fa fa-pencil mr-5 " title="Edit Data" href="{{ url('admin/departments/edit', $record) }}" data-original-title="" ></a>
