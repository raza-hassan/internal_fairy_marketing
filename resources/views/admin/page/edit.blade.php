@extends('layouts.admin-app', ['activePage' => 'products', 'titlePage' => __('Edit Category')])
        ...
        <div class="col-lg-12">
            <section class="panel">
                ...
                <div class="panel-body">
                    <form method="post" action="{{ url('admin/pages/update', $page) }}" autocomplete="off" class="form-horizontal" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                        ...
                        <input type="hidden" name="oldfile" value="{{$page->image}}">
                        
                        <div class="form-group">
                            <label class="col-md-3 control-label">Description</label>
                            <div class="col-md-9">
                                <textarea name="content" placeholder="Description" data-plugin-markdown-editor rows="10">{{ old('content', $page->content) }}</textarea>
                            </div>
                        </div>
                        <div class="form-group">
