                            ...
                            <div class="ps-block__content">
                                ...
                                <div class="accountdiv" style="display: @if(old('account') == '0') none @else block @endif;">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="leadname" name="name" type="text" placeholder="{{ __('Name') }}" value="{{ old('name') }}" required=""/>
                                    </div>
                                    <div class="form-group">
                                        <label>Email</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="leadphone" type="text" placeholder="3001234567" pattern="[0-9]{3}[0-9]{7}" required="" name="phone" value="{{ old('phone') }}" style="width: 69%;"/>
