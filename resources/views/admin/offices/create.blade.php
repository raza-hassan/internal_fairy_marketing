...
<div class="ps-main__wrapper">
    ...
    <section class="ps-new-item">
        <form method="post" action="{{ url('admin/offices/store') }}"  class="form-horizontal" enctype="multipart/form-data" id="leadForm">
            @csrf
            @method('post')
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                        <figure class="ps-block--form-box">
                            <figcaption>Office Info</figcaption>
                            <div class="ps-block__content">
                                ...
                                <div class="accountdiv" style="display: @if(old('account') == '0') none @else block @endif;">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control name"  name="name" type="text" placeholder="{{ __('Designation Name') }}" value="{{ old('name') }}" required=""/>
                                </div>
            ...
            <div class="ps-form__bottom">
                <a class="ps-btn ps-btn--black" href="{{url('admin/office')}}">Cancel</a>
