...
<div class="ps-main__wrapper">
    ...
    <section class="ps-new-item">
        <form method="post" action="{{ url('admin/status/store') }}"  class="form-horizontal" enctype="multipart/form-data" id="leadForm">
            @csrf
            @method('post')
                            ...
                            <div class="ps-block__content">
                                ...
                                <div class="accountdiv" style="display: @if(old('account') == '0') none @else block @endif;">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control type"  name="type" type="text" placeholder="{{ __('Status') }}" value="{{ old('type') }}" required=""/>
                                    </div>
            ...
            <div class="ps-form__bottom">
                <a class="ps-btn ps-btn--black" href="{{url('status')}}">Cancel</a>
