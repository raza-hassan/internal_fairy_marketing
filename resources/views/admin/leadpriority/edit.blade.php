...
<div class="ps-main__wrapper">
    <header class="header--dashboard">
        <div class="header__left">
            <h3>Edit Lead_Priority</h3>
            <p>Edit Lead Priority</p>
        </div>
    ...
    <section class="ps-new-item">
        <form method="post" action="{{ url('admin/priority/update' , $priority) }}"  class="form-horizontal" id="leadForm">
            @csrf
            @method('put')
                            ...
                            <div class="ps-block__content">
                                ...
                                <div class="accountdiv" style="display: @if(old('account') == '0') none @else block @endif;">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control name"  name="name" type="text" placeholder="{{ __('name') }}" value="{{ old('name',$priority->name) }}" required=""/>
                                    </div>
