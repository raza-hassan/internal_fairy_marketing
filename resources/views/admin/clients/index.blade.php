...
<div class="ps-main__wrapper">
    ...
    <header class="header--dashboard">
        ...
        <div class="header__right">
            ...
            <a class="ps-btn success" href="{{ url('admin/client/create') }}"><i class="icon icon-plus mr-2"></i>New Client</a>
    ...
    <section class="ps-items-listing">
        ...
        <div class="ps-section__header">
            ...
            <div class="ps-section__filter">
                ...
                <form class="ps-form--filter" action="{{url('admin/clients/search')}}" method="post">
        ...
        <div class="ps-section__content">
            ...
            <div class="table-responsive">
                ...
                <table class="table ps-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="{{url('client/edit',$client)}}"><strong>{{ $client->name }}</strong></a></td>
                            ...
                            <td>{{ $client->leads_count()->count() }}</td>
                            ...
                            <td>
                                ...
                                <form action="{{ url('admin/client/destroy', $client) }}" method="post">
				...
				<div class="icons-list">
				    ...
				    {{--<a rel="tooltip" href="{{ url('admin/client/edit', $client) }}" data-original-title="" title="">
