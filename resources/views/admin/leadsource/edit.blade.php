...
<div class="ps-main__wrapper">
    <header class="header--dashboard">
        <div class="header__left">
            <h3>Edit Lead_Sources</h3>
            <p>Edit Lead Sources</p>
        </div>
    ...
    <section class="ps-new-item">
        <form method="post" action="{{ url('admin/sources/update' , $sources) }}"  class="form-horizontal" id="leadForm">
            @csrf
            @method('put')
                            ...
                            <div class="ps-block__content">
                                ...
                                <div class="accountdiv" style="display: @if(old('account') == '0') none @else block @endif;">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control type"  name="type" type="text" placeholder="{{ __('Type') }}" value="{{ old('type',$sources->type) }}" required=""/>
                                    </div>
                                </div>
                                ...
                                <div class="accountdiv" style="display: @if(old('account') == '0') none @else block @endif;">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control subtype"  name="subtype" type="text" placeholder="{{ __('Sub_Type') }}" value="{{ old('type',$sources->subtype) }}" required=""/>
                                    </div>
                                </div>
