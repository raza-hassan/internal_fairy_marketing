...
<div class="ps-main__wrapper">
    ...
    <section class="ps-new-item">
        <form method="post" action="{{url('admin/company') }}"  class="form-horizontal"  id="leadForm">
            @csrf
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <figure class="ps-block--form-box">
                            <figcaption>Company Info</figcaption>
                                <div class="ps-block__content">

                                    <div class="form-group">
                                        <label>Company Name<sup>*</sup></label>
                                        <input class="form-control name"  name="name" type="text" placeholder="{{ __('Company Name') }}" value="{{ old('name') }}" required=""/>
                                    </div>
            ...
            <div class="ps-form__bottom">
                <a class="ps-btn ps-btn--black" href="{{url('admin/company')}}">Cancel</a>
