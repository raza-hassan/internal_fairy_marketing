...
<div class="ps-main__wrapper">
    ...
    <section class="ps-items-listing">
 	...
 	<div class="row ">
			...
			<li class="<?php if($todo == 'overdue' || $todo == ''){ echo 'active'; } ?>"><a href="{{url('user/task?user_id='.$user_id.'&tasktype='.app('request')->input('tasktype').'&task=overdue&submit=Filter')}}">Overdue (<?php echo $overdue; ?>)</a></li>
			<li class="<?php if($todo == 'today'){ echo 'active'; } ?>"><a href="{{url('user/task?user_id='.$user_id.'&tasktype='.app('request')->input('tasktype').'&task=today&submit=Filter')}}">Today (<?php echo $today; ?>)</a></li>
			<li class="<?php if($todo == 'tomorrow'){ echo 'active'; } ?>"><a href="{{url('user/task?user_id='.$user_id.'&tasktype='.app('request')->input('tasktype').'&task=tomorrow&submit=Filter')}}">Tomorrow (<?php echo $tomorrow; ?>)</a></li>
			<li class="<?php if($todo == 'week'){ echo 'active'; } ?>"><a href="{{url('user/task?user_id='.$user_id.'&tasktype='.app('request')->input('tasktype').'&task=week&submit=Filter')}}">7 Days (<?php echo $week; ?>)</a></li>
			<li class="<?php if($todo == 'month' ){ echo 'active'; } ?>"><a href="{{url('user/task?user_id='.$user_id.'&tasktype='.app('request')->input('tasktype').'&task=month&submit=Filter')}}"> Month (<?php echo $alltasks; ?>)</a></li>


			{{--<li class="<?php if($todo == 'overdue' || $todo == ''){ echo 'active'; } ?>"><a href="{{url('todos/overdue')}}">Overdue (<?php echo $overdue; ?>)</a></li>
        	            ...
        	            <li class="<?php if($todo == 'month' ){ echo 'active'; } ?>"><a href="{{url('todos/all')}}"> Month (<?php echo $alltasks; ?>)</a></li> --}}
                </ul>
            </div>
        </div>
                ...
                <table class="table ps-table">
                    ...
                    <tbody>
                        ...
                        <tr class="gradeX">
                                ...
                                <div class="client-title tooltip">
                                    ...
                                    <a href="{{url('client/edit',$record->client_id)}}" class="client-title">
                                        <div class="title-flag">
                                            ...
                                            @else
                                                <strong>Client Missing Error</strong>                            
                                            @endif
                            ...
                            <td>
                                @if ($record->leadsTask->is_delete=='0')
                                    <?php
                                    if (!empty($record->item)) {
...
<div class="form-group">
    <div class="row">
        <div class="col-md-12">
            ...
            <input class="form-control deadline" type="text" placeholder="Select Deadline Date" name="deadline" required  value="{{old('deadline')}}" {{--value="{{ old('deadline', date('m/d/Y')) }}" --}} >
        </div>
        {{-- <div class="col-md-6">
