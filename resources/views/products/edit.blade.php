...
<div class="ps-main__wrapper">
    ...
    <section class="ps-new-item">
        <form method="post" action="{{ url('inventory/update', $product) }}" autocomplete="on" class="form-horizontal" enctype="multipart/form-data">
            @csrf
            @method('put')
                            ...
                            <div class="ps-block__content">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" title="Status" name="status">
                                        ...
                                        if ($product->status == 'Token') {
                                            echo 'selected';
                                        }
                                        ?>>Token</option>

                                    
                                        <option value="Partial Token" <?php
                                        if ($product->status == 'Partial Down Payment' || $product->status == 'Partial Token') {
                                            echo 'selected';
                                        }
                                        ?>>Partial Down Payment</option>
