            ...
            <div class="ps-section__filter">
                <form class="ps-form--filter" action="{{url('inventory-update')}}" method="get">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="form-group">
                                <label>Corner OR Non-Corner </label>
                                <div class="bootstrap-select fm-cmp-mg">
                                    <select class="form-control select_corner" name="corner" >
                                        <option <?php if(app('request')->input('corner') == 'all'){ echo 'selected'; } ?> value="all"> All  </option>
                                        <option <?php if(app('request')->input('corner') == 'non-corner'){ echo 'selected'; } ?> value="non-corner"> Non-Corner  </option>
                                        <option <?php if(app('request')->input('corner') == 'corner'){ echo 'selected'; } ?> value="corner"> Corner      </option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="form-group">
                                ...
                                <div class="bootstrap-select fm-cmp-mg">
                                    <select class="form-control" name="change-price" >
                                        <option <?php if(app('request')->input('change-price') == 'update-price'){ echo 'selected'; } ?> value="update-price"> Update (=)     </option>
                                        <option <?php if(app('request')->input('change-price') == 'increase-price'){ echo 'selected'; } ?> value="increase-price"> Increase (+)  </option>
                                        <option <?php if(app('request')->input('change-price') == 'decrease-price'){ echo 'selected'; } ?> value="decrease-price"> Decrease (-)  </option>
                                    </select>
                                </div>
                            </div>
                        </div>

                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 corner_input" @if (app('request')->input('corner_percent') != '' && app('request')->input('corner') == 'corner')
                            style="display:block;"
                        @else
                            style="display:none;"
                        @endif >
                            <div class="form-group">
                                ...
                                <input type="text" name="corner_percent" class="form-control corner_percent_val" placeholder="Enter Percentage" value="{{app('request')->input('corner_percent')}}">
                            </div>
                        </div>
...
<script>
    $(document).on('change', '.select_corner', function (e)
    {
        ...
        if(value == 'corner')
        {
            ...
            $('.corner_percent_val').attr('required', 'true');
            $('.corner_percent_val').val(10);
        }
        else
        {
            $('.corner_input').css('display', 'none');
            $('.corner_percent_val').attr('required', 'false');
            $('.corner_percent_val').val(0);
        }
    });
</script>
