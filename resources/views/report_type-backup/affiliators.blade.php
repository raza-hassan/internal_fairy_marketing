                    ...
                    <?php //$data[19]['followed_up'] = 1000; ?>
                        ...
                        <?php if(isset($data[$record->id]) && !empty($data[$record->id])){ ?>
                            <tr class="gradeX">
                                ...
                                <td style=" text-align:center;"><a href="{{url('report_info/'.$report_of.'/'.$record->id.'/'.$select_task.'/'.$contacted_client)}}" target="_blank">{{$data[$record->id]['affiliator_contacted_client']}}</a></td>
                                <td style=" text-align:center;"><a href="{{url('report_info/'.$report_of.'/'.$record->id.'/'.$select_task.'/'.$meeting_done )}}" target="_blank">{{$data[$record->id]['affiliator_meeting_done']}}</a></td>
                            </tr>
                            <?php } ?>
                        @endforeach
                    </tbody>
