...
<div class="ps-main__wrapper">
    ...
    <section class="ps-items-listing">
        ...
        <?php
            ...
            $meeting_postponed='Meeting Postponed';
            ...
            <div class="table-responsive">
                <table class="table ps-table">
                    <thead>
                        <tr>
                            <th>User</th>
                            <th style="text-align:center;"> Meeting Confirmed  </th>
                            <th style="text-align:center;"> Meeting Cancelled </th>
                            <th style="text-align:center;"> Meeting Postponed </th>
                        </tr>
                    </thead>
                    <tbody>
                    ...
                    <?php //$data[19]['followed_up'] = 1000; ?>
                        ...
                        <?php if(isset($data[$record->id]) && !empty($data[$record->id])){ ?>
                            <tr class="gradeX">
                                ...
                                <td style=" text-align:center;"><a href="{{url('report_info/'.$record->id.'/'.$select_task.'/'.$meeting_confirmed )}}" target="_blank">{{$data[$record->id]['meeting_confirmed']}}</a></td>
                                <td style=" text-align:center;"><a href="{{url('report_info/'.$record->id.'/'.$select_task.'/'.$meeting_cancelled )}}" target="_blank">{{$data[$record->id]['meeting_cancelled']}} </a></td>
                                <td style=" text-align:center;"><a href="{{url('report_info/'.$record->id.'/'.$select_task.'/'.$meeting_postponed )}}" target="_blank">{{$data[$record->id]['meeting_postponed']}} </a></td>
